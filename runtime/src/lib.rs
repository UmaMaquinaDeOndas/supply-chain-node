...
/// import wivsupplychain
pub use pallet_wivsupplychain;
/// An index to a block.
...
/// Configure the wivsupplychain pallet in pallets/wivsupplychain
impl pallet_wivsupplychain::Trait for Runtime {
	type Event = Event;
}
